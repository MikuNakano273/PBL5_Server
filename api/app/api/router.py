...
from app.api.routers import admin, auth, cane, care_links, dashboard, health, internal, me, notifications
...
api_router.include_router(care_links.router, prefix="/api/mobile/v1/care-links", tags=["care-links"])
