...
async def get_my_dashboard(
    ...
    return dashboard_service.get_dashboard(auth_context.user_id, auth_context)
...
async def get_my_devices(
    ...
    return dashboard_service.get_devices(auth_context.user_id, auth_context)
...
async def get_my_locations(
    ...
    return dashboard_service.get_locations(auth_context.user_id, auth_context, limit=limit)
...
async def get_my_alerts(
    ...
    return dashboard_service.get_alerts(auth_context.user_id, auth_context, page=page, limit=limit)
